...
<p align="center">
  ...
  <a href="package.json"><img src="https://img.shields.io/badge/version-1.0.0--dev.3-64748b" alt="开发版本 1.0.0-dev.3"></a>
...
当前版本为 **`1.0.0-dev.3`**，尚未发布到 npm，请从源码构建。建议先阅读下面的能力范围，再用自己的测试文件完成一次“上传 → 参数 → 报价”，熟悉结果后接入日常工作流。
