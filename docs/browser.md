...
Windows and Linux execution and authenticated jlc.com business flows must have their own verification records; this macOS run does not establish their acceptance.
